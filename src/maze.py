# Stolen from https://github.com/boppreh/maze
# With no remorse
...
class Maze(object):
    ...
    def to_grid(self):
        val = self._to_str_matrix()
        grid = [1 if val[j][i] == 'O' else 0 for j in range(1, self.height * 2) for i in range(1, self.width * 2) ]
        return grid
